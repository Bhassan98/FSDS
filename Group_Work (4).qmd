...
User Privacy and Data Security: Although the Inside Airbnb (IA) database does not contain sensitive information, citing it requires ensuring personal privacy is not breached, complying with relevant data protection laws and standards, and aligning with Airbnb's privacy commitments.

Original Data Reliability: Murray Cox's findings suggest data manipulation before public release in New York City (2016), raising concerns about data integrity, accuracy, and broader issues of transparency and operability. London's Airbnb data might still be reliable, but this warrants further substantiation.

Secondary Interpretation or Modification of Data: The website creator, Murray Cox, has processed and filtered Airbnb data, potentially introducing bias. A deep understanding of the original sources, processing methods, and limitations is necessary to mitigate the risk of misleading analysis due to potential biases.

Data Sharing and Reuse: Proper citation of both the original data sources and processors is essential for maintaining academic integrity in research. Additionally, ensuring that the study's purpose aligns with the original research intent of the IA data is important to avoid ethical issues.

Impact on Public Interest: Research on Airbnb data can impact community and public interest (Chica-Olmo, 2020). For example, high Airbnb density in certain areas might affect the long-term rental market, impacting community satisfaction and possibly reinforcing stereotypes about specific groups, like those in low-income or racially diverse neighbourhoods (Serrano, 2020).
...
Hosts with multiple listings are more likely to be professional hosts or management teams, whose properties are dispersed across various locations and commonly situated in downtown areas.

Take **Veeve** and **Blueground** for example.
...
Assessing the quantity of properties owned by hosts, we can gauge the distribution among various host types. Typically, hosts with a modest number (1-5) of listings are more likely to be  individual, while those with a substantial count (more than 20) are more likely to be professional or management hosts.

Airbnb hosts in London are primarily individual hosts, but the presence of more professional hosts shouldn’t be overlooked.
Among them, 1,826 hosts manage more than 5 listings, totaling 24,832 listings and constituting 28.2% of all properties. Notably, STK Homes leads with the highest number of listings at 595. Indeed, Airbnb hosts are increasingly adopting a more professional approach, indicating a trend towsard standardization and accessibility.
...
ax2.plot(interval.index, interval['total_listings'], linewidth = 0.8, color='darkblue', marker='s')
ax2.set_ylabel('total_listings', color='darkblue')
...
Various host types contribute to the diversity of room types, which are dominated by **"Entire home/apt"** (62.1%) and **"Private room"** (37.2%). In addition, there are a small number of "Shared room" and "Hotel room".
...
"Entire home/apt" holds a more substantial share of all listings in central London compared to other regions. This is in contrast to the trend observed in "Private room" listings, where the proportion tends to be smaller.

In the majority of neighborhoods, "Entire home/apt" emerges as the dominant room type, while only a few boroughs on the periphery deviate from this trend, exhibiting a higher proportion of "Private room" listings.
...
Further analysis can be conducted to understand this trend and of Airbnb rental characteristics .

In central areas, Entire home/apt listings are more prevalent. This may be attributed to the predominantly compact nature of central areas, often comprised of apartments. Additionally, these locations tend to be focal points for visitors, who are more inclined to seek private accommodations for short-term stays. Consequently, rental prices there are higher.
...
Therefore, London's Airbnb rental landscape is influenced by both geographical location and visitors’ demands.
...
- Policies that provide support and incentives for small businesses can help sustain and grow the night-time economy. This might include grants and business development services.

- Hosting community-driven events can be a great way to boost local economies and engagement. Policymakers could support this through funding, promotion, and providing the necessary infrastructure.
...
- As these areas are active at night, ensuring the safety and convenience of night workers is essential. This could mean enhanced public transportation services during nighttime hours or increased security measures.
...
In conclusion, this report underscores the significant potential for policy intervention to regulate short-term lets, such as Airbnb, in London, and how this can contribute to addressing the broader housing crisis and inequality in the city (Shabrina et al., 2021). The proliferation of short-term lets has been identified as a contributing factor to the scarcity of affordable housing in London, exacerbating the challenges faced by residents in finding stable, long-term accommodation. By implementing targeted regulations on short-term lets, policymakers have an opportunity to ensure a more balanced housing market, which prioritizes the needs of permanent residents over the demands of the temporary rental market.
