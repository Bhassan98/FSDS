...
for var in variables_to_analyze:
    ...
    ax.set_title(f"Figure 8.{figure_counter}: Local Moran's I for {var}")
...
Airbnbs are principally structured to serve the toursim sector. Tourist attractions are mostly clustered 
